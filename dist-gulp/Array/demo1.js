...
var arr2 = Array.from(arrayLike); // ES6的写法
...
// 传入第二个参数
var arr3 = Array.from([1,, 3,, 5], function (x) {
    return x || 0;
});
console.log(arr3); // [1,0,3,0,5]
var arr4 = Array.from({ length: 2 }, function () {
    return "Mxxim";
});
...
console.log([NaN, 5].findIndex(function (y) {
